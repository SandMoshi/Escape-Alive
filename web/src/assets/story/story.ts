...
const story: Story = {
  ...
  9: {
    ...
    textArray: [
      ...
      "",
      "",
      "One of them remarks that it's curious a journalist is not staying at any of the hotels all the other journalists use.",
      "",
      "",
      "",
      "",
  ...
  "10a": {
    ...
    textArray: [
      ...
      "",
      "",
      "Luckily, you were given a change of clothes that will help you blend in with the locals. Although some locals like to wear western clothing, the subtle differences in styling would quickly give you away if you went out in yesterday's clothes.",
      "",
      "",
      "",
      "",
      "",
      "",
      "As for the rest of your appearance, since you're dark haired with olive skin, you can pass as a local when needed and your arabic is almost perfect after years of training.",
      "",
      "",
      "",
      "",
  ...
  11: {
    ...
    music: "Echoes_of_Time",
    textArray: [
      "There market isn't too far on foot and you arrive in under twenty minutes. It's an open air market lining the narrow winding streets with vendors selling everything from fruit, to homemade soap, to cellphones.",
      "",
      "",
      "",
      "",
      "",
      "",
      "You buy some food then walk around casually. You notice that many people walk quietly past the ISIS fighters standing guard on most corners. Who harass anyone that catches their attention. You pretend to be preoccupied by your shopping as you walk by and luckily they don't pay you any attention. The agency's technical service teams always pick out simple but effective disguises.",
      "",
      "",
      "",
      "",
      "",
      "",
      "You finish your shopping, keeping mental notes everything you saw, the number of fighters, and any chatter you overheard.",
      "",
      "",
      "",
      "",
      "",
      "",
      "You return to the safe house. The wall doesn't have any markings yet. You go inside and soon after begin transmitting the day's events to HQ.",
    ],
    options: {
      a: {
        buttonText: "Back",
